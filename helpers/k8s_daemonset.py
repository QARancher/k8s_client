...
class K8sDaemonSet(K8sResource):
    def __init__(self, name="", api_version="apps/v1", body=None,
                 kind="Daemonset", selector=None, restart_policy="Always"):
        super(K8sDaemonSet, self).__init__(kind=kind, name=name,
    ...
    @property
    def template(self):
        return self["spec"].setdefault("template", {"metadata": {}, "spec": {}})
    ...
    def labels(self, labels):
        ...
        self["spec"]["selector"] = {"matchLabels": labels}
    ...
    def add_image_pull_secrets(self, image_pull_secret_list):
    ...
    def add_containers(self, container_obj):
    ...
    @spec_volumes.setter
    def spec_volumes(self, spec_volumes):
